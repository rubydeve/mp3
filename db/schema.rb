...
ActiveRecord::Schema.define(version: 2020_10_31_234642) do
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.index ["displayname"], name: "index_profiles_on_displayname"
  ...
  create_table "songs", force: :cascade do |t|
    ...
    t.string "slug"
    t.index ["profile_id"], name: "index_songs_on_profile_id"
